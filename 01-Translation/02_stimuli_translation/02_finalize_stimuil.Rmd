...
```{r}
# Path to subs2vec data (subs_count, wiki_count, subs_vec, wiki_vec subfolders)
spaml_path <- "../01_stimuli_selection"

# Path where per-language files from 01_translation_stimuli.Rmd were written
out_path <- "../05_final_languages"

# Path where matched stimuli outputs will be written
match_path <- "../03_match_stimuli/matched_stimuli"
```
...
```{r eval = F}
# original words
en <- import(paste0(out_path, "/en/en_translate.csv"))

# fix fake words ----
en_update <- import(paste0(out_path, "/en/en_translated_final.xlsx"))
cue_fix <- 
  bind_rows(
    (en_update %>% 
      filter(cue_vowel == "no") %>%
...
# export(bind_rows(cue_fix, target_fix), paste0(out_path, "/en/en_tofix.csv"))
en_update <- import(paste0(out_path, "/en/en_tofix_fixed.csv"))
...
export(en, paste0(match_path, "/en_matched.csv"), row.names = F)
...
export(en_final, paste0(out_path, "/en/en_trials_final.csv"))
```
...
```{r eval = F}
# original words
ru <- import(paste0(out_path, "/ru/ru_translate.csv"))

# fix real words ----
ru_update <- import(paste0(out_path, "/ru/ru_translated_final.xlsx"))
...
export(ru, paste0(match_path, "/ru_matched.csv"), row.names = F)
...
en <- import(paste0(out_path, "/en/en_trials_final.csv"))
...
export(ru_final, paste0(out_path, "/ru/ru_trials_final.csv"))
```
...
```{r eval = F}
# original words
tr <- import(paste0(out_path, "/tr/tr_translate.csv"))

# fix real words ----
tr_update <- import(paste0(out_path, "/tr/tr_translated_final.xlsx"))
...
export(tr, paste0(match_path, "/tr_matched.csv"), row.names = F)
...
export(tr_final, paste0(out_path, "/tr/tr_trials_final.csv"))
```
...
ko <- import(paste0(out_path, "/ko/ko_translated_final.xlsx"))
ko_temp <- import(paste0(out_path, "/ko/ko_translate.csv"))
ko <- ko %>% select(colnames(ko_temp))

# fix real words ----
ko_update <- import(paste0(out_path, "/ko/ko_translated_final.xlsx"))
...
export(ko, paste0(match_path, "/ko_matched.csv"), row.names = F)
...
export(ko_final, paste0(out_path, "/ko/ko_trials_final.csv"))
```
...
# that were clearly fixed in the translated sheet
cs <- import(paste0(out_path, "/cs/cs_translated_final.xlsx"))
cs_temp <- import(paste0(out_path, "/cs/cs_translate.csv"))
cs <- cs %>% select(colnames(cs_temp))

# fix real words ----
cs_update <- import(paste0(out_path, "/cs/cs_translated_final.xlsx"))
...
export(cs, paste0(match_path, "/cs_matched.csv"), row.names = F)
...
export(cs_final, paste0(out_path, "/cs/cs_trials_final.csv"))
```
...
ja <- import(paste0(out_path, "/ja/ja_translated_final.xlsx"))
...
export(ja, paste0(match_path, "/ja_matched.csv"), row.names = F)
...
export(ja_final, paste0(out_path, "/ja/ja_trials_final.csv"))
```
...
```{r eval = F}
# original words
da <- import(paste0(out_path, "/da/da_translate.csv"))

# fix real words ----
da_update <- import(paste0(out_path, "/da/da_translated_final.xlsx"))
...
export(da, paste0(match_path, "/da_matched.csv"), row.names = F)
...
export(da_final, paste0(out_path, "/da/da_trials_final.csv"))
```
...
```{r eval = F}
# original words
de <- import(paste0(out_path, "/de/de_translate.csv"))
de$en_cue <- gsub("digusting", "disgusting", de$en_cue)

# fix real words ----
de_update <- import(paste0(out_path, "/de/de_translated_final.xlsx")) %>% 
...
export(de, paste0(match_path, "/de_matched.csv"), row.names = F)
...
export(de_final, paste0(out_path, "/de/de_trials_final.csv"))
```
...
```{r eval = F}
# original words
ar <- import(paste0(out_path, "/ar/ar_translate.csv"))
ar$en_cue <- gsub("digusting", "disgusting", ar$en_cue)

# fix real words ----
ar_update <- import(paste0(out_path, "/ar/ar_translated_final.xlsx")) %>% 
  mutate(across(everything(), tolower))
...
export(ar, paste0(match_path, "/ar_matched.csv"), row.names = F)
...
export(ar_final, paste0(out_path, "/ar/ar_trials_final.csv"))
```
...
```{r eval = F}
# original words
fa <- import(paste0(out_path, "/fa/fa_translate.csv"))
fa$en_cue <- gsub("digusting", "disgusting", fa$en_cue)

# fix real words ----
fa_update <- import(paste0(out_path, "/fa/fa_translated_final.xlsx")) %>% 
  mutate(across(everything(), tolower))
...
export(fa, paste0(match_path, "/fa_matched.csv"), row.names = F)
...
export(fa_final, paste0(out_path, "/fa/fa_trials_final.csv"))
```
...
```{r eval = F}
# original words
fi <- import(paste0(out_path, "/fi/fi_translate.csv"))
fi$en_cue <- gsub("digusting", "disgusting", fi$en_cue)

# fix real words ----
fi_update <- import(paste0(out_path, "/fi/fi_translated_final.xlsx")) %>% 
  mutate(across(everything(), tolower))
...
export(fi, paste0(match_path, "/fi_matched.csv"), row.names = F)
...
export(fi_final, paste0(out_path, "/fi/fi_trials_final.csv"))
```
...
fr <- import(paste0(out_path, "/fr/fr_translated_final.xlsx")) %>% 
  mutate(across(everything(), tolower))
...
export(fr, paste0(match_path, "/fr_matched.csv"), row.names = F)
...
export(fr_final, paste0(out_path, "/fr/fr_trials_final.csv"))
```
...
```{r eval = F}
# original words
el <- import(paste0(out_path, "/el/el_translate.csv"))
el$en_cue <- gsub("digusting", "disgusting", el$en_cue)

# fix real words ----
el_update <- import(paste0(out_path, "/el/el_translated_final.xlsx")) %>% 
  mutate(across(everything(), tolower))
...
export(el, paste0(match_path, "/el_matched.csv"), row.names = F)
...
export(el_final, paste0(out_path, "/el/el_trials_final.csv"))
```
...
```{r eval = F}
# original words
he <- import(paste0(out_path, "/he/he_translate.csv"))
he$en_cue <- gsub("digusting", "disgusting", he$en_cue)

# fix real words ----
he_update <- import(paste0(out_path, "/he/he_translated_final.xlsx")) %>% 
  mutate(across(everything(), tolower))
...
export(he, paste0(match_path, "/he_matched.csv"), row.names = F)
...
export(he_final, paste0(out_path, "/he/he_trials_final.csv"))
```
...
```{r eval = F}
# original words
hu <- import(paste0(out_path, "/hu/hu_translate.csv"))
hu$en_cue <- gsub("digusting", "disgusting", hu$en_cue)

# fix real words ----
hu_update <- import(paste0(out_path, "/hu/hu_translated_final.xlsx")) %>% 
  mutate(across(everything(), tolower))
...
export(hu, paste0(match_path, "/hu_matched.csv"), row.names = F)
...
export(hu_final, paste0(out_path, "/hu/hu_trials_final.csv"))
```
...
```{r eval = F}
# fix real words ----
zh_update <- import(paste0(out_path, "/zh/simplified/zh_translated_final.xlsx")) %>% 
  mutate(across(everything(), tolower))
...
export(zh, paste0(match_path, "/zh_matched.csv"), row.names = F)
...
# update with low cosines from random shuffle ----
# set up model
zh_model <- read.csv(paste0(spaml_path, "/subs_vec/zh_cn/zh_300_5_sg_wxd.csv"), quote="\"")
...
export(zh_final, paste0(out_path, "/zh/zh_trials_final.csv"))
```
...
```{r eval = F}
# fix real words ----
zh_hk_update <- import(paste0(out_path, "/zh/traditional/zh_hk_translated_final.xlsx")) %>% 
  mutate(across(everything(), tolower))
...
export(zh_hk, paste0(match_path, "/zh_hk_matched.csv"), row.names = F)
...
# update with low cosines from random shuffle ----
# set up model
zh_hk_model <- read.csv(paste0(spaml_path, "/subs_vec/zh_tw/tw_300_5_sg_wxd.csv"))
...
export(zh_hk_final, paste0(out_path, "/zh/traditional/zh_hk_trials_final.csv"))
```
...
```{r eval = F}
# original words
pt <- import(paste0(out_path, "/pt/pt_translate.csv"))
pt$en_cue <- gsub("digusting", "disgusting", pt$en_cue)

# fix real words ----
pt_update <- import(paste0(out_path, "/pt/pt_translated_final.xlsx")) %>% 
  mutate(across(everything(), tolower))
...
export(pt, paste0(match_path, "/pt_matched.csv"), row.names = F)
...
export(pt_final, paste0(out_path, "/pt/pt_trials_final.csv"))
```
...
```{r eval = F}
# original words
pt_br <- import(paste0(out_path, "/pt/pt_translate.csv"))
pt_br$en_cue <- gsub("digusting", "disgusting", pt_br$en_cue)

# fix real words ----
pt_br_update <- import(paste0(out_path, "/pt/pt_br/pt_br_translated_final.xlsx")) %>% 
  mutate(across(everything(), tolower))
...
export(pt_br, paste0(match_path, "/br_pt_matched.csv"), row.names = F)
...
# update with low cosines from random shuffle ----
# set up model
pt_br_model <- read.table(paste0(spaml_path, "/subs_vec/pt/subs.pt.1e6.txt"), quote="\"")
...
export(pt_br_final, paste0(out_path, "/pt/pt_br/pt_br_trials_final.csv"))
```

### pt Portuguese Match

```{r eval = F}
pt <- import(paste0(match_path, "/pt_matched.csv"))
pt_br <- import(paste0(match_path, "/br_pt_matched.csv"))
...
```{r eval = F}
# original words
sr <- import(paste0(out_path, "/sr/sr_translate.csv"))
sr$en_cue <- gsub("digusting", "disgusting", sr$en_cue)

# fix real words ----
sr_update <- import(paste0(out_path, "/sr/sr_translated_final.xlsx")) %>% 
  mutate(across(everything(), tolower))
...
export(sr, paste0(match_path, "/sr_matched.csv"), row.names = F)
...
export(sr_final, paste0(out_path, "/sr/sr_trials_final.csv"))
```
...
```{r eval = F}
# original words
es <- import(paste0(out_path, "/es/es_translated_final.xlsx"))
...
export(es, paste0(match_path, "/es_matched.csv"), row.names = F)
...
export(es_final, paste0(out_path, "/es/es_trials_final.csv"))
```
...
```{r eval = F}
# original words
no <- import(paste0(out_path, "/no/no_translate.csv"))
no$en_cue <- gsub("digusting", "disgusting", no$en_cue)

# fix real words ----
no_update <- import(paste0(out_path, "/no/no_translated_final.xlsx")) %>% 
  mutate(across(everything(), tolower))
...
export(no, paste0(match_path, "/no_matched.csv"), row.names = F)
...
export(no_final, paste0(out_path, "/no/no_trials_final.csv"))
```
...
```{r eval = F}
# original words
it <- import(paste0(out_path, "/it/it_translate.csv"))
it$en_cue <- gsub("digusting", "disgusting", it$en_cue)

# fix real words ----
it_update <- import(paste0(out_path, "/it/it_translated_final.xlsx")) %>% 
  mutate(across(everything(), tolower))
...
export(it,  paste0(match_path, "/it_matched.csv"), row.names = F)
...
export(it_final, paste0(out_path, "/it/it_trials_final.csv"))
```
...
```{r eval = F}
# original words
ur <- import(paste0(out_path, "/ur/ur_translate.csv"))
ur$en_cue <- gsub("digusting", "disgusting", ur$en_cue)

# fix real words ----
ur_update <- import(paste0(out_path, "/ur/ur_translate2 SPAML Apr 2022.xlsx")) %>% 
  mutate(across(everything(), tolower))
...
export(ur, paste0(match_path, "/ur_matched.csv"), row.names = F)
...
export(ur_final, paste0(out_path, "/ur/ur_trials_final.csv"))
```
...
```{r eval = F}
# original words
pl <- import(paste0(out_path, "/pl/pl_translate.csv"))
pl$en_cue <- gsub("digusting", "disgusting", pl$en_cue)

# fix real words ----
pl_update <- import(paste0(out_path, "/pl/pl_translated_final.xlsx")) %>% 
  mutate(across(everything(), tolower))
...
export(pl, paste0(match_path, "/pl_matched.csv"), row.names = F)
...
export(pl_final, paste0(out_path, "/pl/pl_trials_final.csv"))
```
...
```{r eval = F}
# fix real words ----
ro_update <- import(paste0(out_path, "/ro/ro_translated_final.xlsx")) %>% 
  mutate(across(everything(), tolower))
...
export(ro, paste0(match_path, "/ro_matched.csv"), row.names = F)
...
export(ro_final, paste0(out_path, "/ro/ro_trials_final.csv"))
```
...
```{r eval = F}
# original words
nl <- import(paste0(out_path, "/nl/nl_translate.csv"))
nl$en_cue <- gsub("digusting", "disgusting", nl$en_cue)

# fix real words ----
nl_update <- import(paste0(out_path, "/nl/nl_translated_final.xlsx")) %>% 
  mutate(across(everything(), tolower))
...
export(nl, paste0(match_path, "/nl_matched.csv"), row.names = F)
...
export(nl_final, paste0(out_path, "/nl/nl_trials_final.csv"))
```
...
```{r eval = F}
# original words
sk <- import(paste0(out_path, "/sk/sk_translate.csv"))
sk$en_cue <- gsub("digusting", "disgusting", sk$en_cue)

# fix real words ----
sk_update <- import(paste0(out_path, "/sk/sk_translated_final.xlsx")) %>% 
  mutate(across(everything(), tolower))
...
export(sk, paste0(match_path, "/sk_matched.csv"), row.names = F)
...
export(sk_final, paste0(out_path, "/sk/sk_trials_final.csv"))
```
...
```{r eval = F}
# original words
th <- import(paste0(out_path, "/th/th_stimuli_final.xlsx"))
th$en_cue <- gsub("digusting", "disgusting", th$en_cue)

# pull in fake words
th_fake <- import(paste0(out_path, "/th/th_fake_final.xlsx"))
...
export(th, paste0(match_path, "/th_matched.csv"), row.names = F)
...
# update with low cosines from random shuffle ----
# set up model
th_model <- import(paste0(spaml_path, "/subs_vec/th/matrix_with_labels.csv"))
...
export(th_final, paste0(out_path, "/th/th_trials_final.csv"))
```
...
```{r eval = F}
# original words
sl <- import(paste0(out_path, "/sl/sl_translate_final.xlsx"))
...
export(sl, paste0(match_path, "/sl_matched.csv"), row.names = F)
...
export(sl_final, paste0(out_path, "/sl/sl_trials_final.csv"))
```
...
```{r eval = F}
# original words
hi <- import(paste0(out_path, "/hi/hi_translate_final.xlsx"))
...
export(hi, paste0(match_path, "/hi_matched.csv"), row.names = F)
...
export(hi_final, paste0(out_path, "/hi/hi_trials_final.csv"))
```
...
```{r eval = F}
# original words
uk <- import(paste0(out_path, "/uk/uk_translated_final.xlsx"))
uk$en_cue <- gsub("digusting", "disgusting", uk$en_cue)

uk$uk_cue <- uk$uk_cue_trans
uk$uk_target <- uk$uk_target_trans
uk$uk_fake_cue <- uk$uk_fake_cue_trans
uk$uk_fake_target <- uk$uk_fake_target_trans

uk <- uk %>% 
  select(en_cue, en_target, uk_cue, uk_target, 
         uk_fake_cue, uk_fake_target) 

sum(duplicated(uk$uk_cue))
sum(duplicated(uk$uk_target))
sum(duplicated(uk$uk_fake_cue))
sum(duplicated(uk$uk_fake_target))

nrow(uk %>% filter(uk_cue == uk_target))

export(uk, paste0(match_path, "/uk_matched.csv"), row.names = F)
...
en <- import(paste0(out_path, "/en/en_trials_final.csv"))
uk$en_cue <- tolower(uk$en_cue)
uk$en_target <- tolower(uk$en_target)
# match unrelated pairs as a start 
uk_unrelated <- en %>% filter(type == "unrelated")
for (i in 1:nrow(uk_unrelated)){
  uk_unrelated$en_cue[i] <- uk$uk_cue[uk$en_cue == uk_unrelated$en_cue[i]]
  uk_unrelated$en_target[i] <- uk$uk_target[uk$en_target == uk_unrelated$en_target[i]]
}

uk_trials <- rbind(uk_trials,
                   uk_unrelated %>% select(-en_cosine) %>% 
                     rename("uk_cue" = "en_cue", 
                            "uk_target" = "en_target"), 
...
# update with low cosines from random shuffle ----
# set up model
uk_model <- import(paste0(spaml_path, "/subs_vec/uk_300_5_sg_wxd.csv"))
...
# vectorized cosine lookups over just the words we actually need, so the
# reshuffle/swap loops below don't re-subset the 1.2M-row model per pair.
# words missing from the model get cosine 0 (same fallback used in the
# ja/ko/cs sections above).
uk_vocab <- unique(c(uk_trials$uk_cue, uk_trials$uk_target,
                     uk_trials$uk_fake_cue, uk_trials$uk_fake_target))
uk_vocab <- uk_vocab[uk_vocab %in% rownames(uk_model)]
uk_vec_mat <- as.matrix(uk_model[uk_vocab, ])
uk_vec_norms <- sqrt(rowSums(uk_vec_mat^2))
names(uk_vec_norms) <- uk_vocab

get_cosine_safe <- function(cue, target) {
  if (!(cue %in% uk_vocab) || !(target %in% uk_vocab)) return(0)
  as.numeric((uk_vec_mat[cue, ] %*% uk_vec_mat[target, ]) /
    (uk_vec_norms[cue] * uk_vec_norms[target]))
}

# cosine between one word and many candidate words at once
cosine_many <- function(word, words) {
  out <- rep(0, length(words))
  if (!(word %in% uk_vocab)) return(out)
  idx <- match(words, uk_vocab)
  valid <- !is.na(idx)
  if (any(valid)) {
    dots <- as.vector(uk_vec_mat[idx[valid], , drop = FALSE] %*% uk_vec_mat[word, ])
    out[valid] <- dots / (uk_vec_norms[idx[valid]] * uk_vec_norms[word])
  }
  out
}
...
for (row in 1:nrow(uk_trials)){
  ...
  if(uk_trials$type[row] != "nonword") {
    ...
    uk_trials$uk_cosine[row] <- get_cosine_safe(uk_trials$uk_cue[row], uk_trials$uk_target[row])
...
# update trials that have cosines too big
uk_trials$ok <- TRUE
uk_trials$ok[uk_trials$type == "unrelated" & abs(uk_trials$uk_cosine) > .15] <- FALSE

good_trials <- uk_trials %>% filter(ok == TRUE)
bad_trials <- uk_trials %>% filter(ok == FALSE)

# iterate on those bad trials until all gone
# run reshuffle passes until the bad_trials count is stable for 5
# iterations in a row (or hits 0), instead of a single manual pass
prev_counts <- integer(0)
iter <- 0
repeat {
  iter <- iter + 1

  bad_trials$uk_target <- sample(bad_trials$uk_target,
                                 size = length(bad_trials$uk_target),
                                 replace = FALSE)
  for (row in 1:nrow(bad_trials)){
      bad_trials$uk_cosine[row] <- get_cosine_safe(bad_trials$uk_cue[row], bad_trials$uk_target[row])
  }

  good_trials <- bind_rows(good_trials,
                           (bad_trials %>% filter(uk_cosine < .15)))
  bad_trials <- bad_trials %>% filter(uk_cosine >= .15)

  n_bad <- nrow(bad_trials)
  message("reshuffle iter ", iter, " bad_trials: ", n_bad)
  prev_counts <- c(prev_counts, n_bad)

  if (n_bad == 0) break
  if (length(prev_counts) >= 5 && length(unique(tail(prev_counts, 5))) == 1) break
  if (iter >= 300) break
}
nrow(bad_trials)

# resolve remaining bad pairs by swapping targets 1:1 against the good
# unrelated pool, removing each used good pair from that pool as soon as
# it's consumed. That's the fix for the old bug: the previous version let
# multiple bad pairs pick the *same* good pair as a swap partner, which
# added more new rows than it removed and inflated the trial count past
# 1000. Doing it one-at-a-time with removal guarantees the total unrelated
# count is conserved exactly, no matter how many pairs get swapped.
remaining_good <- good_trials %>% filter(type == "unrelated")
other_trials <- good_trials %>% filter(type != "unrelated")

new_pairs <- data.frame(uk_cue = character(), uk_target = character(),
                        type = character(), cue_type = character(),
                        target_type = character(), uk_cosine = numeric())
still_bad <- bad_trials[0, ]

for (i in seq_len(nrow(bad_trials))) {
  cue_b <- bad_trials$uk_cue[i]
  target_b <- bad_trials$uk_target[i]

  if (nrow(remaining_good) == 0) {
    still_bad <- bind_rows(still_bad, bad_trials[i, ])
    next
  }

  cos_to_target_b <- cosine_many(target_b, remaining_good$uk_cue)
  cos_from_cue_b  <- cosine_many(cue_b, remaining_good$uk_target)

  candidates <- which(abs(cos_to_target_b) < .15 & abs(cos_from_cue_b) < .15)
  ...
  best <- candidates[which.min(abs(cos_to_target_b[candidates]) + abs(cos_from_cue_b[candidates]))]

  cue_g <- remaining_good$uk_cue[best]
  target_g <- remaining_good$uk_target[best]

  new_pairs <- bind_rows(new_pairs,
    data.frame(uk_cue = cue_b, uk_target = target_g, type = "unrelated",
               cue_type = "word", target_type = "word",
               uk_cosine = cos_from_cue_b[best]),
    data.frame(uk_cue = cue_g, uk_target = target_b, type = "unrelated",
               cue_type = "word", target_type = "word",
               uk_cosine = cos_to_target_b[best]))

  remaining_good <- remaining_good[-best, ]
}

message("swapped ", nrow(bad_trials) - nrow(still_bad), " of ", nrow(bad_trials),
       " -- still unresolved (kept, flagged for manual review): ", nrow(still_bad))

# unresolved pairs keep their original (over-threshold) pairing rather
# than being dropped, so the total row count still lands on exactly 1000
uk_final <- bind_rows(other_trials, remaining_good, new_pairs, still_bad)
uk_final$still_over_threshold <- uk_final$uk_cue %in% still_bad$uk_cue &
  uk_final$uk_target %in% still_bad$uk_target

# only a few found
sum(duplicated(uk_final[ , c("uk_cue", "uk_target")]))

# check cosines
tapply(uk_final$uk_cosine, uk_final$type, mean, na.rm = T)
tapply(uk_final$uk_cosine, uk_final$type, min, na.rm = T)
tapply(uk_final$uk_cosine, uk_final$type, max, na.rm = T)

# check that everyone has a mate
target_table <- uk_final %>% 
  filter(target_type == "word") %>% 
  filter(type != "nonword") %>% 
  count(uk_target) %>% 
  filter(n != 2)

weird_trials <- uk_final %>% 
  filter(target_type == "word") %>% 
  filter(type != "nonword") %>% 
  filter(uk_target %in% target_table$uk_target)

# check for NA
sum(is.na(uk_final$uk_cue))
sum(is.na(uk_final$uk_target))
sum(grepl("^NA", uk_final$uk_cue))
sum(grepl("^NA", uk_final$uk_target))

# check rows
nrow(uk_final)
table(uk_final$type, uk_final$cue_type, uk_final$target_type)

uk_final$ok <- NULL

export(uk_final, paste0(out_path, "/uk/uk_trials_final.csv"))
```
