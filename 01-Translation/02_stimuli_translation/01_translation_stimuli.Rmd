...
# Path to the folder containing subs2vec data (subs_count, wiki_count, subs_vec, wiki_vec subfolders).
# Defaults to 01_stimuli_selection, which has the expected folder structure.
# Change this if your data is stored elsewhere (e.g., an external drive).
spaml_path <- "../01_stimuli_selection"

# Path where per-language output files will be written
out_path <- "../05_final_languages"
```
...
en_subs <- import(paste0(spaml_path, "/subs_count/en/en.zip"))
...
write.csv(en_fake_words, paste0(out_path, "/en/en_fake_cues.csv"), row.names = F)
...
write.csv(en_fake_words, paste0(out_path, "/en/en_fake_targets.csv"), row.names = F)
...
en$en_cosine <- NULL
write.csv(en, paste0(out_path, "/en/en_translate.csv"), row.names = F)

# get cosines -----

# set up model
en_model <- read.table(paste0(spaml_path, "/subs_vec/en/subs.en.1e6.txt"), quote="\"")
...
# write it out 
write.csv(en_trials, paste0(out_path, "/en/en_trials.csv"), row.names = F)
...
af_subs <- import(paste0(spaml_path, "/wiki_count/af/af.zip"))
...
write.csv(af_fake_words, paste0(out_path, "/af/af_fake_cues.csv"), row.names = F)
...
write.csv(af_fake_words, paste0(out_path, "/af/af_fake_targets.csv"), row.names = F)
...
af$af_cosine <- NULL
write.csv(af, paste0(out_path, "/af/af_translate.csv"), row.names = F)

# get cosines -----

# set up model
af_model <- read.table(paste0(spaml_path, "/wiki_vec/af/wiki.af.1e6.txt"), quote="\"")
...
# write it out 
write.csv(af_trials, paste0(out_path, "/af/af_trials.csv"), row.names = F)
...
ar_subs <- import(paste0(spaml_path, "/subs_count/ar/ar.zip"))
...
write.csv(ar_fake_words, paste0(out_path, "/ar/ar_fake_cues.csv"), row.names = F)
...
write.csv(ar_fake_words, paste0(out_path, "/ar/ar_fake_targets.csv"), row.names = F)
...
ar$ar_cosine <- NULL
write.csv(ar, paste0(out_path, "/ar/ar_translate.csv"), row.names = F)

# get cosines -----

# set up model
ar_model <- read.table(paste0(spaml_path, "/subs_vec/ar/subs.ar.1e6.txt"), quote="\"")
...
# write it out 
write.csv(ar_trials, paste0(out_path, "/ar/ar_trials.csv"), row.names = F)
...
bg_subs <- import(paste0(spaml_path, "/subs_count/bg/bg.zip"))
...
write.csv(bg_fake_words, paste0(out_path, "/bg/bg_fake_cues.csv"), row.names = F)
...
write.csv(bg_fake_words, paste0(out_path, "/bg/bg_fake_targets.csv"), row.names = F)
...
bg$bg_cosine <- NULL
write.csv(bg, paste0(out_path, "/bg/bg_translate.csv"), row.names = F)

# get cosines -----

# set up model
bg_model <- read.table(paste0(spaml_path, "/subs_vec/bg/subs.bg.1e6.txt"), quote="\"")
...
# write it out 
write.csv(bg_trials, paste0(out_path, "/bg/bg_trials.csv"), row.names = F)
...
ca_subs <- import(paste0(spaml_path, "/subs_count/ca/ca.zip"))
...
write.csv(ca_fake_words, paste0(out_path, "/ca/ca_fake_cues.csv"), row.names = F)
...
write.csv(ca_fake_words, paste0(out_path, "/ca/ca_fake_targets.csv"), row.names = F)
...
ca$ca_cosine <- NULL
write.csv(ca, paste0(out_path, "/ca/ca_translate.csv"), row.names = F)

# get cosines -----

# set up model
ca_model <- read.table(paste0(spaml_path, "/subs_vec/ca/subs.ca.1e6.txt"), quote="\"")
...
# write it out 
write.csv(ca_trials, paste0(out_path, "/ca/ca_trials.csv"), row.names = F)
...
cs_subs <- import(paste0(spaml_path, "/subs_count/cs/cs.zip"))
...
write.csv(cs_fake_words, paste0(out_path, "/cs/cs_fake_cues.csv"), row.names = F)
...
write.csv(cs_fake_words, paste0(out_path, "/cs/cs_fake_targets.csv"), row.names = F)
...
cs$cs_cosine <- NULL
write.csv(cs, paste0(out_path, "/cs/cs_translate.csv"), row.names = F)

# get cosines -----

# set up model
cs_model <- read.table(paste0(spaml_path, "/subs_vec/cs/subs.cs.1e6.txt"), quote="\"")
...
# write it out 
write.csv(cs_trials, paste0(out_path, "/cs/cs_trials.csv"), row.names = F)
...
da_subs <- import(paste0(spaml_path, "/subs_count/da/da.zip"))
...
write.csv(da_fake_words, paste0(out_path, "/da/da_fake_cues.csv"), row.names = F)
...
write.csv(da_fake_words, paste0(out_path, "/da/da_fake_targets.csv"), row.names = F)
...
da$da_cosine <- NULL
write.csv(da, paste0(out_path, "/da/da_translate.csv"), row.names = F)

# get cosines -----

# set up model
da_model <- read.table(paste0(spaml_path, "/subs_vec/da/subs.da.1e6.txt"), quote="\"")
...
# write it out 
write.csv(da_trials, paste0(out_path, "/da/da_trials.csv"), row.names = F)
...
# get patterns -----
de_subs <- import(paste0(spaml_path, "/subs_count/de/de.zip"))
...
write.csv(de_fake_words, paste0(out_path, "/de/de_fake_cues.csv"), row.names = F)
...
write.csv(de_fake_words, paste0(out_path, "/de/de_fake_targets.csv"), row.names = F)
...
de$de_cosine <- NULL
write.csv(de, paste0(out_path, "/de/de_translate.csv"), row.names = F)

# get cosines -----

# set up model
de_model <- read.table(paste0(spaml_path, "/subs_vec/de/subs.de.1e6.txt"), quote="\"")
...
# write it out 
write.csv(de_trials, paste0(out_path, "/de/de_trials.csv"), row.names = F)
...
el_subs <- import(paste0(spaml_path, "/subs_count/el/el.zip"))
...
write.csv(el_fake_words, paste0(out_path, "/el/el_fake_cues.csv"), row.names = F)
...
write.csv(el_fake_words, paste0(out_path, "/el/el_fake_targets.csv"), row.names = F)
...
el$el_cosine <- NULL
write.csv(el, paste0(out_path, "/el/el_translate.csv"), row.names = F)

# get cosines -----

# set up model
el_model <- read.table(paste0(spaml_path, "/subs_vec/el/subs.el.1e6.txt"), quote="\"")
...
# write it out 
write.csv(el_trials, paste0(out_path, "/el/el_trials.csv"), row.names = F)
...
es_subs <- import(paste0(spaml_path, "/subs_count/es/es.zip"))
...
write.csv(es_fake_words, paste0(out_path, "/es/es_fake_cues.csv"), row.names = F)
...
write.csv(es_fake_words, paste0(out_path, "/es/es_fake_targets.csv"), row.names = F)
...
es$es_cosine <- NULL
write.csv(es, paste0(out_path, "/es/es_translate.csv"), row.names = F)

# get cosines -----

# set up model
es_model <- read.table(paste0(spaml_path, "/subs_vec/es/subs.es.1e6.txt"), quote="\"")
...
# write it out 
write.csv(es_trials, paste0(out_path, "/es/es_trials.csv"), row.names = F)
...
et_subs <- import(paste0(spaml_path, "/subs_count/et/et.zip"))
...
write.csv(et_fake_words, paste0(out_path, "/et/et_fake_cues.csv"), row.names = F)
...
write.csv(et_fake_words, paste0(out_path, "/et/et_fake_targets.csv"), row.names = F)
...
et$et_cosine <- NULL
write.csv(et, paste0(out_path, "/et/et_translate.csv"), row.names = F)

# get cosines -----

# set up model
et_model <- read.table(paste0(spaml_path, "/subs_vec/et/subs.et.1e6.txt"), quote="\"")
...
# write it out 
write.csv(et_trials, paste0(out_path, "/et/et_trials.csv"), row.names = F)
...
eu_subs <- import(paste0(spaml_path, "/subs_count/eu/eu.zip"))
...
write.csv(eu_fake_words, paste0(out_path, "/eu/eu_fake_cues.csv"), row.names = F)
...
write.csv(eu_fake_words, paste0(out_path, "/eu/eu_fake_targets.csv"), row.names = F)
...
eu$eu_cosine <- NULL
write.csv(eu, paste0(out_path, "/eu/eu_translate.csv"), row.names = F)

# get cosines -----

# set up model
eu_model <- read.table(paste0(spaml_path, "/subs_vec/eu/subs.eu.1e6.txt"), quote="\"")
...
# write it out 
write.csv(eu_trials, paste0(out_path, "/eu/eu_trials.csv"), row.names = F)
...
# not a typo, Arabic technically doesn't allow hyphenation
fa_subs <- import(paste0(spaml_path, "/subs_count/fa/fa.zip"))
...
write.csv(fa_fake_words, paste0(out_path, "/fa/fa_fake_cues.csv"), row.names = F)
...
write.csv(fa_fake_words, paste0(out_path, "/fa/fa_fake_targets.csv"), row.names = F)
...
fa$fa_cosine <- NULL
write.csv(fa, paste0(out_path, "/fa/fa_translate.csv"), row.names = F)

# get cosines -----

# set up model
fa_model <- read.table(paste0(spaml_path, "/subs_vec/fa/subs.fa.1e6.txt"), quote="\"")
...
# write it out 
write.csv(fa_trials, paste0(out_path, "/fa/fa_trials.csv"), row.names = F)
...
fi_subs <- import(paste0(spaml_path, "/subs_count/fi/fi.zip"))
...
write.csv(fi_fake_words, paste0(out_path, "/fi/fi_fake_cues.csv"), row.names = F)
...
write.csv(fi_fake_words, paste0(out_path, "/fi/fi_fake_targets.csv"), row.names = F)
...
write.csv(fi, paste0(out_path, "/fi/fi_translate.csv"), row.names = F)

# get cosines -----

# set up model
fi_model <- read.table(paste0(spaml_path, "/subs_vec/fi/subs.fi.1e6.txt"), quote="\"")
...
# write it out 
write.csv(fi_trials, paste0(out_path, "/fi/fi_trials.csv"), row.names = F)
...
# get patterns -----
fr_subs <- import(paste0(spaml_path, "/subs_count/fr/fr.zip"))
...
write.csv(fr_fake_words, paste0(out_path, "/fr/fr_fake_cues.csv"), row.names = F)
...
write.csv(fr_fake_words, paste0(out_path, "/fr/fr_fake_targets.csv"), row.names = F)
...
fr$fr_cosine <- NULL
write.csv(fr, paste0(out_path, "/fr/fr_translate.csv"), row.names = F)

# get cosines -----

# set up model
fr_model <- read.table(paste0(spaml_path, "/subs_vec/fr/subs.fr.1e6.txt"), quote="\"")
...
# write it out 
write.csv(fr_trials, paste0(out_path, "/fr/fr_trials.csv"), row.names = F)
...
gl_subs <- import(paste0(spaml_path, "/subs_count/gl/gl.zip"))
...
write.csv(gl_fake_words, paste0(out_path, "/gl/gl_fake_cues.csv"), row.names = F)
...
write.csv(gl_fake_words, paste0(out_path, "/gl/gl_fake_targets.csv"), row.names = F)
...
gl$gl_cosine <- NULL
write.csv(gl, paste0(out_path, "/gl/gl_translate.csv"), row.names = F)

# get cosines -----

# set up model
gl_model <- read.table(paste0(spaml_path, "/subs_vec/gl/subs.gl.1e6.txt"), quote="\"")
...
# write it out 
write.csv(gl_trials, paste0(out_path, "/gl/gl_trials.csv"), row.names = F)
...
he_subs <- import(paste0(spaml_path, "/subs_count/he/he.zip"))
...
write.csv(he_fake_words, paste0(out_path, "/he/he_fake_cues.csv"), row.names = F)
...
write.csv(he_fake_words, paste0(out_path, "/he/he_fake_targets.csv"), row.names = F)
...
he$he_cosine <- NULL
write.csv(he, paste0(out_path, "/he/he_translate.csv"), row.names = F)

# get cosines -----

# set up model
he_model <- read.table(paste0(spaml_path, "/subs_vec/he/subs.he.1e6.txt"), quote="\"")
...
# write it out 
write.csv(he_trials, paste0(out_path, "/he/he_trials.csv"), row.names = F)
...
hi_subs <- import(paste0(spaml_path, "/wiki_count/hi/hi.zip"))
...
write.csv(hi_fake_words, paste0(out_path, "/hi/hi_fake_cues.csv"), row.names = F)
...
write.csv(hi_fake_words, paste0(out_path, "/hi/hi_fake_targets.csv"), row.names = F)
...
hi$hi_cosine <- NULL
write.csv(hi, paste0(out_path, "/hi/hi_translate.csv"), row.names = F)

# get cosines -----

# set up model
hi_model <- read.table(paste0(spaml_path, "/wiki_vec/hi/wiki.hi.1e6.txt"), quote="\"")
...
# write it out 
write.csv(hi_trials, paste0(out_path, "/hi/hi_trials.csv"), row.names = F)
...
hr_subs <- import(paste0(spaml_path, "/subs_count/hr/hr.zip"))
...
write.csv(hr_fake_words, paste0(out_path, "/hr/hr_fake_cues.csv"), row.names = F)
...
write.csv(hr_fake_words, paste0(out_path, "/hr/hr_fake_targets.csv"), row.names = F)
...
hr$hr_cosine <- NULL
write.csv(hr, paste0(out_path, "/hr/hr_translate.csv"), row.names = F)

# get cosines -----

# set up model
hr_model <- read.table(paste0(spaml_path, "/subs_vec/hr/subs.hr.1e6.txt"), quote="\"")
...
# write it out 
write.csv(hr_trials, paste0(out_path, "/hr/hr_trials.csv"), row.names = F)
...
hu_subs <- import(paste0(spaml_path, "/subs_count/hu/hu.zip"))
...
write.csv(hu_fake_words, paste0(out_path, "/hu/hu_fake_cues.csv"), row.names = F)
...
write.csv(hu_fake_words, paste0(out_path, "/hu/hu_fake_targets.csv"), row.names = F)
...
hu$hu_cosine <- NULL
write.csv(hu, paste0(out_path, "/hu/hu_translate.csv"), row.names = F)

# get cosines -----

# set up model
hu_model <- read.table(paste0(spaml_path, "/subs_vec/hu/subs.hu.1e6.txt"), quote="\"")
...
# write it out 
write.csv(hu_trials, paste0(out_path, "/hu/hu_trials.csv"), row.names = F)
...
hy_subs <- import(paste0(spaml_path, "/wiki_count/hy/hy.zip"))
...
write.csv(hy_fake_words, paste0(out_path, "/hy/hy_fake_cues.csv"), row.names = F)
...
write.csv(hy_fake_words, paste0(out_path, "/hy/hy_fake_targets.csv"), row.names = F)
...
hy$hy_cosine <- NULL
write.csv(hy, paste0(out_path, "/hy/hy_translate.csv"), row.names = F)

# get cosines -----

# set up model
hy_model <- read.table(paste0(spaml_path, "/wiki_vec/hy/wiki.hy.1e6.txt"), quote="\"")
...
# write it out 
write.csv(hy_trials, paste0(out_path, "/hy/hy_trials.csv"), row.names = F)
...
id_subs <- import(paste0(spaml_path, "/subs_count/id/id.zip"))
...
write.csv(id_fake_words, paste0(out_path, "/id/id_fake_cues.csv"), row.names = F)
...
write.csv(id_fake_words, paste0(out_path, "/id/id_fake_targets.csv"), row.names = F)
...
id$id_cosine <- NULL
write.csv(id, paste0(out_path, "/id/id_translate.csv"), row.names = F)

# get cosines -----

# set up model
id_model <- read.table(paste0(spaml_path, "/subs_vec/id/subs.id.1e6.txt"), quote="\"")
...
# write it out 
write.csv(id_trials, paste0(out_path, "/id/id_trials.csv"), row.names = F)
...
# get patterns -----
it_subs <- import(paste0(spaml_path, "/subs_count/it/it.zip"))
...
write.csv(it_fake_words, paste0(out_path, "/it/it_fake_cues.csv"), row.names = F)
...
write.csv(it_fake_words, paste0(out_path, "/it/it_fake_targets.csv"), row.names = F)
...
it$it_cosine <- NULL
write.csv(it, paste0(out_path, "/it/it_translate.csv"), row.names = F)

# get cosines -----

# set up model
it_model <- read.table(paste0(spaml_path, "/subs_vec/it/subs.it.1e6.txt"), quote="\"")
...
# write it out 
write.csv(it_trials, paste0(out_path, "/it/it_trials.csv"), row.names = F)
...
ja_subs <- import(paste0(spaml_path, "/subs_count/ja/ja.zip"))
...
write.csv(ja_fake_words, paste0(out_path, "/ja/ja_fake_cues.csv"), row.names = F)
...
write.csv(ja_fake_words, paste0(out_path, "/ja/ja_fake_targets.csv"), row.names = F)
...
ja$ja_cosine <- NULL
write.csv(ja, paste0(out_path, "/ja/ja_translate.csv"), row.names = F)

# get cosines -----

# set up model
ja_model <- import(paste0(spaml_path, "/subs_vec/ja/ja_300_5_sg_wxd.csv"))
...
# write it out 
write.csv(ja_trials, paste0(out_path, "/ja/ja_trials.csv"), row.names = F)
...
ko_subs <- import(paste0(spaml_path, "/subs_count/ko/ko.zip"))
...
write.csv(ko_fake_words, paste0(out_path, "/ko/ko_fake_cues.csv"), row.names = F)
...
write.csv(ko_fake_words, paste0(out_path, "/ko/ko_fake_targets.csv"), row.names = F)
...
beepr::beep()
ko$ko_cosine <- NULL
write.csv(ko, paste0(out_path, "/ko/ko_translate.csv"), row.names = F)

# get cosines -----

# set up model
ko_model <- read.table(paste0(spaml_path, "/subs_vec/ko/subs.ko.1e6.txt"), quote="\"")
...
# write it out 
write.csv(ko_trials, paste0(out_path, "/ko/ko_trials.csv"), row.names = F)
...
lt_subs <- import(paste0(spaml_path, "/subs_count/lt/lt.zip"))
...
write.csv(lt_fake_words, paste0(out_path, "/lt/lt_fake_cues.csv"), row.names = F)
...
write.csv(lt_fake_words, paste0(out_path, "/lt/lt_fake_targets.csv"), row.names = F)
...
lt$lt_cosine <- NULL
write.csv(lt, paste0(out_path, "/lt/lt_translate.csv"), row.names = F)

# get cosines -----

# set up model
lt_model <- read.table(paste0(spaml_path, "/subs_vec/lt/subs.lt.1e6.txt"), quote="\"")
...
# write it out 
write.csv(lt_trials, paste0(out_path, "/lt/lt_trials.csv"), row.names = F)
...
lv_subs <- import(paste0(spaml_path, "/subs_count/lv/lv.zip"))
...
write.csv(lv_fake_words, paste0(out_path, "/lv/lv_fake_cues.csv"), row.names = F)
...
write.csv(lv_fake_words, paste0(out_path, "/lv/lv_fake_targets.csv"), row.names = F)
...
lv$lv_cosine <- NULL
write.csv(lv, paste0(out_path, "/lv/lv_translate.csv"), row.names = F)

# get cosines -----

# set up model
lv_model <- read.table(paste0(spaml_path, "/subs_vec/lv/subs.lv.1e6.txt"), quote="\"")
...
# write it out 
write.csv(lv_trials, paste0(out_path, "/lv/lv_trials.csv"), row.names = F)
...
nl_subs <- import(paste0(spaml_path, "/subs_count/nl/nl.zip"))
...
write.csv(nl_fake_words, paste0(out_path, "/nl/nl_fake_cues.csv"), row.names = F)
...
write.csv(nl_fake_words, paste0(out_path, "/nl/nl_fake_targets.csv"), row.names = F)
...
nl$nl_cosine <- NULL
write.csv(nl, paste0(out_path, "/nl/nl_translate.csv"), row.names = F)

# get cosines -----

# set up model
nl_model <- read.table(paste0(spaml_path, "/subs_vec/nl/subs.nl.1e6.txt"), quote="\"")
...
# write it out 
write.csv(nl_trials, paste0(out_path, "/nl/nl_trials.csv"), row.names = F)
...
no_subs <- import(paste0(spaml_path, "/subs_count/no/no.zip"))
...
write.csv(no_fake_words, paste0(out_path, "/no/no_fake_cues.csv"), row.names = F)
...
write.csv(no_fake_words, paste0(out_path, "/no/no_fake_targets.csv"), row.names = F)
...
no$no_cosine <- NULL
write.csv(no, paste0(out_path, "/no/no_translate.csv"), row.names = F)

# get cosines -----

# set up model
no_model <- read.table(paste0(spaml_path, "/subs_vec/no/subs.no.1e6.txt"), quote="\"")
...
# write it out 
write.csv(no_trials, paste0(out_path, "/no/no_trials.csv"), row.names = F)
...
pl_subs <- import(paste0(spaml_path, "/subs_count/pl/pl.zip"))
...
write.csv(pl_fake_words, paste0(out_path, "/pl/pl_fake_cues.csv"), row.names = F)
...
write.csv(pl_fake_words, paste0(out_path, "/pl/pl_fake_targets.csv"), row.names = F)
...
pl$pl_cosine <- NULL
write.csv(pl, paste0(out_path, "/pl/pl_translate.csv"), row.names = F)

# get cosines -----

# set up model
pl_model <- read.table(paste0(spaml_path, "/subs_vec/pl/subs.pl.1e6.txt"), quote="\"")
...
# write it out 
write.csv(pl_trials, paste0(out_path, "/pl/pl_trials.csv"), row.names = F)
...
pt_subs <- import(paste0(spaml_path, "/subs_count/pt/pt.zip"))
...
write.csv(pt_fake_words, paste0(out_path, "/pt/pt_fake_cues.csv"), row.names = F)
...
write.csv(pt_fake_words, paste0(out_path, "/pt/pt_fake_targets.csv"), row.names = F)
...
pt$pt_cosine <- NULL
write.csv(pt, paste0(out_path, "/pt/pt_translate.csv"), row.names = F)

# get cosines -----

# set up model
pt_model <- read.table(paste0(spaml_path, "/subs_vec/pt/subs.pt.1e6.txt"), quote="\"")
...
# write it out 
write.csv(pt_trials, paste0(out_path, "/pt/pt_trials.csv"), row.names = F)
...
ro_subs <- import(paste0(spaml_path, "/subs_count/ro/ro.zip"))
...
write.csv(ro_fake_words, paste0(out_path, "/ro/ro_fake_cues.csv"), row.names = F)
...
write.csv(ro_fake_words, paste0(out_path, "/ro/ro_fake_targets.csv"), row.names = F)
...
ro$ro_cosine <- NULL
write.csv(ro, paste0(out_path, "/ro/ro_translate.csv"), row.names = F)

# get cosines -----

# set up model
ro_model <- read.table(paste0(spaml_path, "/subs_vec/ro/subs.ro.1e6.txt"), quote="\"")
...
# write it out 
write.csv(ro_trials, paste0(out_path, "/ro/ro_trials.csv"), row.names = F)
...
ru_subs <- import(paste0(spaml_path, "/subs_count/ru/ru.zip"))
...
write.csv(ru_fake_words, paste0(out_path, "/ru/ru_fake_cues.csv"), row.names = F)
...
write.csv(ru_fake_words, paste0(out_path, "/ru/ru_fake_targets.csv"), row.names = F)
...
ru$ru_cosine <- NULL
write.csv(ru, paste0(out_path, "/ru/ru_translate.csv"), row.names = F)

# get cosines -----

# set up model
ru_model <- read.table(paste0(spaml_path, "/subs_vec/ru/subs.ru.1e6.txt"), quote="\"")
...
# write it out 
write.csv(ru_trials, paste0(out_path, "/ru/ru_trials.csv"), row.names = F)
...
sk_subs <- import(paste0(spaml_path, "/subs_count/sk/sk.zip"))
...
write.csv(sk_fake_words, paste0(out_path, "/sk/sk_fake_cues.csv"), row.names = F)
...
write.csv(sk_fake_words, paste0(out_path, "/sk/sk_fake_targets.csv"), row.names = F)
...
sk$sk_cosine <- NULL
write.csv(sk, paste0(out_path, "/sk/sk_translate.csv"), row.names = F)

# get cosines -----

# set up model
sk_model <- read.table(paste0(spaml_path, "/subs_vec/sk/subs.sk.1e6.txt"), quote="\"")
...
# write it out 
write.csv(sk_trials, paste0(out_path, "/sk/sk_trials.csv"), row.names = F)
...
sl_subs <- import(paste0(spaml_path, "/subs_count/sl/sl.zip"))
...
write.csv(sl_fake_words, paste0(out_path, "/sl/sl_fake_cues.csv"), row.names = F)
...
write.csv(sl_fake_words, paste0(out_path, "/sl/sl_fake_targets.csv"), row.names = F)
...
sl$sl_cosine <- NULL
write.csv(sl, paste0(out_path, "/sl/sl_translate.csv"), row.names = F)

# get cosines -----

# set up model
sl_model <- read.table(paste0(spaml_path, "/subs_vec/sl/subs.sl.1e6.txt"), quote="\"")
...
# write it out 
write.csv(sl_trials, paste0(out_path, "/sl/sl_trials.csv"), row.names = F)
...
sr_subs <- import(paste0(spaml_path, "/subs_count/sr/sr.zip"))
...
write.csv(sr_fake_words, paste0(out_path, "/sr/sr_fake_cues.csv"), row.names = F)
...
write.csv(sr_fake_words, paste0(out_path, "/sr/sr_fake_targets.csv"), row.names = F)
...
sr$sr_cosine <- NULL
write.csv(sr, paste0(out_path, "/sr/sr_translate.csv"), row.names = F)

# get cosines -----

# set up model
sr_model <- read.table(paste0(spaml_path, "/subs_vec/sr/subs.sr.1e6.txt"), quote="\"")
...
# write it out 
write.csv(sr_trials, paste0(out_path, "/sr/sr_trials.csv"), row.names = F)
...
sv_subs <- import(paste0(spaml_path, "/subs_count/sv/sv.zip"))
...
write.csv(sv_fake_words, paste0(out_path, "/sv/sv_fake_cues.csv"), row.names = F)
...
write.csv(sv_fake_words, paste0(out_path, "/sv/sv_fake_targets.csv"), row.names = F)
...
sv$sv_cosine <- NULL
write.csv(sv, paste0(out_path, "/sv/sv_translate.csv"), row.names = F)

# get cosines -----

# set up model
sv_model <- read.table(paste0(spaml_path, "/subs_vec/sv/subs.sv.1e6.txt"), quote="\"")
...
# write it out 
write.csv(sv_trials, paste0(out_path, "/sv/sv_trials.csv"), row.names = F)
...
ta_subs <- import(paste0(spaml_path, "/wiki_count/ta/ta.zip"))
...
write.csv(ta_fake_words, paste0(out_path, "/ta/ta_fake_cues.csv"), row.names = F)
...
write.csv(ta_fake_words, paste0(out_path, "/ta/ta_fake_targets.csv"), row.names = F)
...
ta$ta_cosine <- NULL
write.csv(ta, paste0(out_path, "/ta/ta_translate.csv"), row.names = F)

# get cosines -----

# set up model
ta_model <- read.table(paste0(spaml_path, "/wiki_vec/ta/wiki.ta.1e6.txt"), quote="\"")
...
# write it out 
write.csv(ta_trials, paste0(out_path, "/ta/ta_trials.csv"), row.names = F)
...
tr_subs <- import(paste0(spaml_path, "/subs_count/tr/tr.zip"))
...
write.csv(tr_fake_words, paste0(out_path, "/tr/tr_fake_cues.csv"), row.names = F)
...
write.csv(tr_fake_words, paste0(out_path, "/tr/tr_fake_targets.csv"), row.names = F)
...
tr$tr_cosine <- NULL
write.csv(tr, paste0(out_path, "/tr/tr_translate.csv"), row.names = F)

# get cosines -----

# set up model
tr_model <- read.table(paste0(spaml_path, "/subs_vec/tr/subs.tr.1e6.txt"), quote="\"")
...
# write it out 
write.csv(tr_trials, paste0(out_path, "/tr/tr_trials.csv"), row.names = F)
...
uk_subs <- import(paste0(spaml_path, "/subs_count/uk/uk.zip"))
...
write.csv(uk_fake_words, paste0(out_path, "/uk/uk_fake_cues.csv"), row.names = F)
...
write.csv(uk_fake_words, paste0(out_path, "/uk/uk_fake_targets.csv"), row.names = F)
...
uk$uk_cosine <- NULL
write.csv(uk, paste0(out_path, "/uk/uk_translate.csv"), row.names = F)

# get cosines -----

# set up model
uk_model <- read.table(paste0(spaml_path, "/subs_vec/uk/subs.uk.1e6.txt"), quote="\"")
...
# write it out 
write.csv(uk_trials, paste0(out_path, "/uk/uk_trials.csv"), row.names = F)
...
ur_subs <- import(paste0(spaml_path, "/wiki_count/ur/ur.zip"))
...
write.csv(ur_fake_words, paste0(out_path, "/ur/ur_fake_cues.csv"), row.names = F)
...
write.csv(ur_fake_words, paste0(out_path, "/ur/ur_fake_targets.csv"), row.names = F)
...
ur$ur_cosine <- NULL
write.csv(ur, paste0(out_path, "/ur/ur_translate.csv"), row.names = F)

# get cosines -----

# set up model
ur_model <- read.table(paste0(spaml_path, "/wiki_vec/ur/wiki.ur.1e6.txt"), quote="\"")
...
# write it out 
write.csv(ur_trials, paste0(out_path, "/ur/ur_trials.csv"), row.names = F)
...
vi_subs <- import(paste0(spaml_path, "/subs_count/vi/vi.zip"))
...
write.csv(vi_fake_words, paste0(out_path, "/vi/vi_fake_cues.csv"), row.names = F)
...
write.csv(vi_fake_words, paste0(out_path, "/vi/vi_fake_targets.csv"), row.names = F)
...
th$vi_cosine <- NULL
write.csv(vi, paste0(out_path, "/vi/vi_translate.csv"), row.names = F)

# get cosines -----

# set up model
vi_model <- read.table(paste0(spaml_path, "/subs_vec/vi/subs.vi.1e6.txt"), quote="\"")
...
# write it out 
write.csv(vi_trials, paste0(out_path, "/vi/vi_trials.csv"), row.names = F)
...
Note: Chinese does not use the Wuggy-like algorithm above. Instead, nonwords are sampled from the Chinese Lexicon Project (`CLP.xlsx`), which provides validated Chinese nonwords. The word vector model is also a custom file rather than a standard subs2vec download.
...
clp <- import(paste0(out_path, "/zh/CLP.xlsx"), which = 2)
...
zh$zh_cosine <- NULL
write.csv(zh, paste0(out_path, "/zh/zh_translate.csv"), row.names = F)

# get cosines -----

# set up model
zh_model <- import(paste0(spaml_path, "/subs_vec/zh_cn/zh_300_5_sg_wxd.csv"))
...
# write it out 
write.csv(zh_trials, paste0(out_path, "/zh/zh_trials.csv"), row.names = F)
...
Note: Thai was added by a collaborator and translated directly rather than going through our standard workflow above. The input file (`th_translated_updated.xlsx`) has already been processed with correct column names; `th_translated.xlsx` is the raw collaborator-provided file with different column names (`th_cue_trans`, `th_target_trans`).

```{r eval = F}
# get data ----
th <- import(paste0(out_path, "/th/th_translated_updated.xlsx"))
...
export(th, paste0(out_path, "/th/th_translated_updated.xlsx"), rowNames = F)
gc()
```